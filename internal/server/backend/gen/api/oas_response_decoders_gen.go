...
func decodeAuthGetResponse(resp *http.Response) (res AuthGetRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		var wrapper AuthGetOK
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-Sc-User-Id" header.
		{
			...
			if err := func() error {
				...
				return res, errors.Wrap(err, "parse X-Sc-User-Id header")
			}
		}
		return &wrapper, nil
	case 401:
	...
	// Default response.
	res, err := func() (res AuthGetRes, err error) {
